 ...
 */
package com.modules.schedule.controllers.util;
...
@Named(value = "mobilePageControllerSchedule")
@SessionScoped
public class MobilePageController implements Serializable {

    private static final String MOBILE_PAGES_PREFIX = "/core/modules/schedule_events/views/m";
