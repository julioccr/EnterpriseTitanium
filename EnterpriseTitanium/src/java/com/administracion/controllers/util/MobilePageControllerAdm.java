...
@Named(value = "mobilePageControllerAdm")
@SessionScoped
public class MobilePageControllerAdm implements Serializable {

    private static final String MOBILE_PAGES_PREFIX = "/core/administration/views/m";
     ...
     */
    public MobilePageControllerAdm() {
    }
